...
const HTTP_WITX: &str = "test/http/deislabs_http_v01.witx";
const HTTP_TESTS_DIR: &str = "test/http/tests";

const PING_WITX: &str = "test/http/deislabs_ping_v01.witx";
const PING_TESTS_DIR: &str = "test/ping/tests";
